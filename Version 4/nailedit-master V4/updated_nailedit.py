...
class Viewer(QtWidgets.QMainWindow):
    def __init__(self, parameters):
        ...
        self.imageLabel.setSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        ...
        self.imageLabel2.setSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        ...
        self.imageLabel3.setSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        ...
        self.outPath = os.path.join(os.getcwd(),  'render', 'img_{:04d}.jpg')
        ...
        self.timer.timeout.connect(self.workImage)
    ...
    def showImage(self, image, slot=0):
        ...
        if slot == 0:
            self.qim = qimage   # don't let Python clean up the data
            self.imageLabel.setPixmap(QPixmap.fromImage(self.qim))
            self.imageLabel.adjustSize()
        elif slot == 1:
            self.qim2 = qimage   # don't let Python clean up the data
            self.imageLabel2.setPixmap(QPixmap.fromImage(self.qim2))
...
if __name__ == '__main__':
    ...
    params = {
        ...
        "inputImagePath": os.path.join(os.getcwd(), "einstein3.png"),
        # "edgesImagePath": "einstein_edges.png",   # optional
        "edgesImagePath": os.path.join(os.getcwd(), "einstein_edges.png"),   # optional
        "edgeThreshold": 0.3,
        ...
        "loadNailsFrom": os.path.join(os.getcwd(), "t37.json")
    }
