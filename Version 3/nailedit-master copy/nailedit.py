...
if __name__ == '__main__':
    ...
    params = {
        "proc_width":380,       # image size
        "proc_height":380,      #
        "ppi": mpp,             # scale factor to real world, meters per pixel
        "searchRadius": 0.25,
        "nailDistMin": 9 / 1000.0 / mpp,      # minimum nail distance
        "nailDistMax": 16.0 / 1000.0 / mpp,     # maximum nail distance
        "nailDiameter": 1.7 / 1000.0 / mpp,       # diameter of the nail for avoidance
        ...
        "edgesImagePath": "ada_edges3.png",   # optional
        "edgeThreshold": 0.3,
